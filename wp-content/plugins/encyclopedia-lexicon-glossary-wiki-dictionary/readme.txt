...
> #### Kick-Start
> Read the feature list below or [take a look at the screenshots](https://wordpress.org/plugins/encyclopedia-lexicon-glossary-wiki-dictionary/screenshots/)!
...
* Fixed warnings in getTagRelatedTerms() function in core class
* Fixed related terms in different languages (WPML)
* added new action hook "encyclopedia_tag_related_terms_query_object"
...
= 1.6.19 =
* added filter parameters to encyclopedia_term_link_title: $more and $length
* created new filter encyclopedia_link_term_in_content
* Small code cleanups
...
= 1.6.15 =
* Fixed: Cross Linker string chache algorithm
...
= 1.6.11 =
* Fixed: Removed term limit from Taxonomy Cloud widget
...
= 1.6.5 =
* Added new cross linker option to link terms case sensitive
